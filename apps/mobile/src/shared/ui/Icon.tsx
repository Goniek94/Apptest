...
/**
 * Zestaw line-ikon (Feather-style) — te SAME ścieżki co w web (components/ui/Icon),
 * renderowane przez react-native-svg. Dzięki temu apka ma identyczne ikony co prototyp.
 */
const PATHS = {
